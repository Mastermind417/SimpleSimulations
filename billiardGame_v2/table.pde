...
int[] black = new int[]{0, 0, 0};
  ...
  void createBumps() {
    ...
    angledPieces.add(new AngledPiece(1, 0, 2));
    angledPieces.add(new AngledPiece(1, 1, 3));   
    ...
    angledPieces.add(new AngledPiece(4, 0, 1));
    angledPieces.add(new AngledPiece(4, 2, 3));
